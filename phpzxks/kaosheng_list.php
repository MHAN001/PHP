...
<title>考生</title><link rel="stylesheet" href="css.css" type="text/css">
</head>
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td bgcolor='#EBE2FE'>用户名</td><td bgcolor='#EBE2FE'>密码</td><td bgcolor='#EBE2FE'>姓名</td><td bgcolor='#EBE2FE'>电话</td><td bgcolor='#EBE2FE'>性别</td><td bgcolor='#EBE2FE'>邮箱</td><td bgcolor='#EBE2FE'>身份证</td><td bgcolor='#EBE2FE'>地址</td><td bgcolor='#EBE2FE'>照片</td>
...
?></td>
	...
	?>&tablename=kaosheng" onclick="return confirm('真的要删除？')">删除</a> <a href="kaosheng_updt.php?id=<?php
		echo mysql_result($query,$i,"id");
	?>">修改</a></td>
  </tr>
  	<?php
...
<p align="center"><a href="kaosheng_list.php?pagecurrent=1">首页</a>, <a href="kaosheng_list.php?pagecurrent=<?php echo $pagecurrent-1;?>">前一页</a> ,<a href="kaosheng_list.php?pagecurrent=<?php echo $pagecurrent+1;?>">后一页</a>, <a href="kaosheng_list.php?pagecurrent=<?php echo $pagecount;?>">末页</a>, 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 </p>
