...
if ($addnew=="1" )
{
	...
	mysql_query($sql);
	echo "<script>javascript:alert('修改成功!');location.href='duoxuanti_list.php';</script>";
}
?>
...
<title>修改多选题</title><link rel="stylesheet" href="css.css" type="text/css"><script language="javascript" src="js/Calendar.js"></script>
</head>
