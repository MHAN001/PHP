...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td bgcolor='#EBE2FE'>单选题数</td><td bgcolor='#EBE2FE'>单选分值</td><td bgcolor='#EBE2FE'>多选题数</td><td bgcolor='#EBE2FE'>多选分值</td>
...
?></td>
	...
	<a href="del.php?id=<?php echo mysql_result($query,$i,"id");?>
	&tablename=shijuanshengcheng" onclick="return confirm('真的要删除？')"></a> <a href="shijuan_detail2.php?id=<?php echo mysql_result($query,$i,"id");
	?>">开始考试</a></td>
  </tr>
  	<?php
	}
