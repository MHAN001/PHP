...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"> 
      ...
      <tr><td>编号：</td><td><input name='bianhao' type='text' id='bianhao' value='<?php echo mysql_result($query,$i,bianhao);?>' /></td></tr><tr><td>单选题数：</td><td><input name='danxuantishu' type='text' id='danxuantishu' value='<?php echo mysql_result($query,$i,danxuantishu);?>' /></td></tr><tr><td>单选分值：</td><td><input name='danxuanfenzhi' type='text' id='danxuanfenzhi' value='<?php echo mysql_result($query,$i,danxuanfenzhi);?>' /></td></tr><tr><td>多选题数：</td><td><input name='duoxuantishu' type='text' id='duoxuantishu' value='<?php echo mysql_result($query,$i,duoxuantishu);?>' /></td></tr><tr><td>多选分值：</td><td><input name='duoxuanfenzhi' type='text' id='duoxuanfenzhi' value='<?php echo mysql_result($query,$i,duoxuanfenzhi);?>' /></td></tr>
